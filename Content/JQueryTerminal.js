...
(function()
{
 ...
 SC$1=Global.StartupCode$JQueryTerminal$Client=Global.StartupCode$JQueryTerminal$Client||{};
 ...
 Var=UI.Var=UI.Var||{};
 JQueryTerminal_Templates=Global.JQueryTerminal_Templates=Global.JQueryTerminal_Templates||{};
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.interpreter=function(command)
  {
   ...
   }))),(p=Handler.CompleteHoles(b.k,b.h,[["projname",0]]),(i=new TemplateInstance.New(p[1],JQueryTerminal_Templates.form(p[0])),(b.i=i,i)))).get_Doc(),this.echo("<div id=\""+id+"\"></div>",{
    raw:true
 ...
 JQueryTerminal_Templates.form=function(h)
 {
